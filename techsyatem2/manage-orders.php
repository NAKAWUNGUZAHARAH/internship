                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Orders</li>
                                    <li class="active"><a href="manage-orders.php"><i class="fa fa-home"></i> Manage Orders</a></li>
                                </ul>
                            </div>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <?php 
                                                    ...
                                                    <td><?php echo htmlentities($cnt); ?></td>
                                                        ...
                                                        <td><?php echo htmlentities($result->service_offered); ?></td>
                                                        <td><?php echo htmlentities($result->status); ?></td>
                                                        <td><?php echo htmlentities($result->total_orders); ?></td>
