...
if(isset($_POST['username']) && $_POST['username'] != ''){
	...
	if($_POST['ddlLoginType'] == '1'){
		//here for admin
		$sql= mysqli_query($link,"SELECT * FROM manager WHERE Email = '".make_safe($_POST['username'])."'");
		$password = 'Password';
	}
	
	else if($_POST['ddlLoginType'] == '2'){
		//here for student
		$sql= mysqli_query($link,"SELECT * FROM login WHERE UserName = '".make_safe($_POST['username'])."'");
		$password = 'Password';
	}
	...
	if($row = mysqli_fetch_array($sql)){
		...
		$result_s_arr = mysqli_query($link,"Select * from manager");
...
<title>FFWS online Rostering System</title>
<!-- BOOTSTRAP STYLES-->
...
<div class="container">
  ...
  <div class="row text-center ">
    <div class="col-md-12"><br/>
      <span style="font-size:35px;font-weight:bold;color:red;">FFWS</span> <span style="font-size:18px;">Apartment Management System</span></div>
  </div>
  <br/>
  <div class="row ">
