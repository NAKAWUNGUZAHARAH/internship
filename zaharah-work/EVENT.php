...
<!-- ****** Header Area End ****** -->
   <!-- ******  Area Start ****** -->
     <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url(img/images/3.png);">
            <div class="container h-100">
                <div class="row h-100 align-items-end justify-content-left">
                    <div class="col-12 col-md-8 col-lg-6">
                        <div class="offer-content-area wow fadeInUp" data-wow-delay="1s">
                            <h4 class="text-primary">ONGOING-PROGRAMS <span class=" karl-level text-primary">join-us!</span></h4>
                            <p>* Adult education</p>
                            <p>* Vacancist program</p>
                            <p>* Internship program</p>
                            <p>*Volunteering programs</p>
                            <p>*Computer classes</p>
                            <p>*Business classes</p>
                            <a href="program.php" class="btn bg-dark3 mt-5">Read more>>> </a>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <!-- ****** message Area Start ****** -->
        <div class="  bg-light ">
            <div class="container myform ">
                <h1>Register for aprogram</h1>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="contact_details_area mt-50 clearfix">
                            <form id="signup-form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <select class="custom-select d-block w-100" name="program" id="program">
                                        <option value="Adult education">Adult education</option>
                                        <option value="vacancist program">Vacancist program</option>
                                        <option value="Internship">Internship</option>
                                        <option value="Volunteering programs">Volunteering</option>
                                        <option value="Internship">computer class</option>
                                        <option value="Volunteering programs">Business classes</option>
                                    </select>
                                </div>   
                                    <div class="col-12 mb-3">
                            ...
                            <button id="submit" class="btn bg-dark3 ml-5" type="submit" name="submitform">Submit</button>
   ...
   <!-- ****** Footer Area Start ****** -->
   <!-- ****** Footer Area Start ****** -->
  <footer class="footer_area bg-dark mt-0 mb-0">
            <div class="container">
                <div class="row">
