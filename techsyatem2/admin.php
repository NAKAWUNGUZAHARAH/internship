...
<body class="">
    <div class="main-wrapper">
        ...
        <div class="">
            <div class="row">
                <h1 align="center">St. Maria Goretti Results <br> Dashboard</h1>
                            ...
                            <div class="col-md-10 col-md-offset-1 pt-50">
                                ...
                                <div class="row mt-30 ">
                                    <div class="col-md-11">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div class="section-title">
                                                    <p class="sub-title">St. Maria Goretti Results System</p>
                                                </div>
                                        ...
                                        <p class="text-muted text-center"><small>Copyright © SMAGOK</small></p>
                                    </div>
