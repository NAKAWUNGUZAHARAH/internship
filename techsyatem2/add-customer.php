                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <form class="form-horizontal" id="add-form" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">customerid</label>
                                                <div class="col-sm-10 col-md-6">
                                                    <input type="text" name="id" class="form-control" id="id" required="required" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-6">
                                                    <input type="text" name="lastname" class="form-control" id="lastname" maxlength="5" required="required" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-6">
                                                    <input type="text" name="dob" class="form-control" id="dob" required="required" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
